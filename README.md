...
For a detailed explanation on how things work, check out the [guide](https://vuejs-templates.github.io/webpack/) and [docs for vue-loader](https://vuejs.github.io/vue-loader/en).
...
npm install vue-i18n-gettext vue-gettext @kngai/vue-gettext-tools vue-server-renderer@{same version as vue}
