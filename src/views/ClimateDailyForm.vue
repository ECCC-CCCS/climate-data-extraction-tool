...
export default {
  ...
  beforeMount () {
    ...
    if (this.numStationClimateDaily === 0) { // prevent duplicate AJAX
      this.$store.dispatch('stations/retrieveClimateStations', {
  ...
  computed: {
    ...
    urlDatasetMinDate: function () {
      return this.oapif_url_base + '/' + this.oapif_layer + '/items?f=json&sortby=LOCAL_DATE&limit=1'
    },
    ...mapState('stations', [
